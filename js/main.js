/*===================================================
Project: codefusion - IT Solutions & Business Services Responsive HTML5 Bootstrap5  Website Template 
Auther: amin-themes
Version: 2.0
...
$(function () {
  ...
  // function to fire the counter plugin
  ...
  function fireCounter() {
    if ($(".js-stats-counter").length) {
      if ($.fn.countTo && !counterShowsUp) {
        ...
        if ($(window).scrollTop() + $(window).innerHeight() - 50 >= pos) {
          $(".counter").countTo();
          counterShowsUp = true;
        }
      }
